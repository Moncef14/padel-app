...
INSERT INTO administrateurs (id, nom, prenom, email, mot_de_passe, role, site_id) VALUES
    (1, 'Ouassal',  'Moncef',  'moncef.ouassal@padelapp.be',   '$2a$10$cndo3TD4Lti7HomignDtmeg.LbWurSCWWKoAZt5twEtQ4eSFdHZp2', 'ADMIN_GLOBAL', NULL),
    (2, 'Houllich', 'Soumaya', 'soumaya.houllich@padelapp.be', '$2a$10$cndo3TD4Lti7HomignDtmeg.LbWurSCWWKoAZt5twEtQ4eSFdHZp2', 'ADMIN_SITE',   1);
